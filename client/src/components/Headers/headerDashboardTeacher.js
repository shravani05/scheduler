            ...
            <Navbar.Collapse id="responsive-navbar-nav" className="responsive-collapse">
                ...
                <Nav className = "header-nav">
                    ...
                    <NavDropdown title="Student Roster" id="collasible-nav-dropdown" className="nav-links">
                        <NavDropdown.Item className="drop-items" href="/teacher-dashboard-all">All Students</NavDropdown.Item>
                        <NavDropdown.Item className="drop-items" href="/teacher-dashboard-online">Online Students</NavDropdown.Item>
                        <NavDropdown.Item className="drop-items" href="/teacher-dashboard-offline">Offline Students</NavDropdown.Item>
                    </NavDropdown>
